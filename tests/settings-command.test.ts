...
describe('Settings Command', () => {
  ...
  describe('settingsCommand', () => {
    ...
    it('should validate settings file', async () => {
      ...
      // Command calls console.log('Settings are valid!')
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Settings are valid!'));
    });
    ...
    it('should apply settings from file', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Settings applied successfully!'));
    });
    ...
    it('should reset settings to default', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Settings reset to default successfully!'));
    });
